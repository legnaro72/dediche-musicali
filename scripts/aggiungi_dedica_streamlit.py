...
def prepare_values(values: dict) -> dict:
    ...
    # audio_type è conservato solo per retrocompatibilità dei dati esistenti.
...
def render_dedication_form(prefix: str, existing_image_source: str = ""):
    ...
    with st.expander("SEO e opzioni avanzate"):
        st.caption("audio_type viene derivato automaticamente dalla sorgente per compatibilità con le dediche esistenti.")
